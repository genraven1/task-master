  ...
  return (
    <div>
      ...
      <div className="px-4 pt-3 pb-2">
        <h1 className="text-white font-bold text-xl">📅 Dailies</h1>
        <p className="text-gray-400 text-sm mt-0.5">Tasks that reset every day</p>
      </div>
      <TaskList tasks={tasks ?? []} type="DAILY" isLoading={isLoading} onXpGained={handleXpGained} />
    </div>
  );
}
